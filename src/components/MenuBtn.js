...
import CloseQ from './svgicons/CloseQ';
...
export default MenuBtn = ({ image, onPress }) => (
  <TouchableOpacity style={styles.menuBtn} onPress={onPress} elevation={2}>
    {image == "burger" ? <Burger width={20 * em} height={20 * em} /> : (image == "close" ? <Close color={"#928ea7"} /> : (image == "closeB" ? <CloseQ color={"#251B4D"} /> : <LeftArrow width={20 * em} height={20 * em} color={"#251b4d"} />))}
  </TouchableOpacity>
)
